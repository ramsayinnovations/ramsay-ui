...
const select = {
  ...
  main: tw`relative`,
  button: {
    wrapper: tw`inline-block w-full rounded-md shadow-sm`,
    base: tw`cursor-default relative w-full rounded-md border border-gray-300 bg-white pl-3 pr-10 py-2 text-left focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition ease-in-out duration-150 sm:text-sm sm:leading-5`,
  ...
  listBox: {
    base: tw`max-h-60 rounded-md py-1 text-base leading-6 shadow-xs overflow-auto focus:outline-none sm:text-sm sm:leading-5`,
    item: {
